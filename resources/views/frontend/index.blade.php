            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                        ...
                        <ul class="nav">
                            @foreach($categories as $category)
                                <li class="dropdown menu-item"><a href="#" class="dropdown-toggle"
                                            ...
                                            aria-hidden="true"></i> @if(session()->get('language') == 'hindi') {{$category->category_name_hin}}  @else {{$category->category_name_en}} @endif
                                    </a>
                                            ...
                                            <div class="row">
                                                ...
                                                @foreach($subcategories as $subCat)
                                                    <div class="col-sm-12 col-md-3">
                                                        <h2 class="title"> @if(session()->get('language') == 'hindi')
                                                                {{$subCat->subcategory_name_hin}}  @else {{$subCat->subcategory_name_en}} @endif</h2>
                                                        <!-- Get SubCategory Data -->

                                                        @php
                                                            $sub_subcategories = App\Models\SubSubCategory::where('sub_category_id',$subCat->id)->orderBy('sub_sub_category_name_en','ASC')->get();
                                                        @endphp

                                                        @foreach($sub_subcategories as $subSubCat)
                                                            <ul class="links list-unstyled">
                                                                <li>
                                                                    <a href="#"> @if(session()->get('language') == 'hindi')
                                                                            {{$subSubCat->sub_sub_category_name_hin}}  @else {{$subSubCat->sub_sub_category_name_en}} @endif</a>
                                                                </li>
                                                            </ul>
                                                        @endforeach
                                                    </div>
                            ...
                            <div class="item">
                                <div class="products">
                                    ...
                                    <div class="product-info text-left m-t-20">
                                        <h3 class="name"><a
                                                href="{{url('product/details/'.$product->id.'/'.$product->pro_slug_en)}}">{{$product->pro_name_en}}</a>
                                        </h3>
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"><a
                                                                    href="{{url('product/details/'.$product->id.'/'.$product->pro_slug_en)}}">
                                                                    <img
                ...
                <div class="sidebar-widget product-tag wow fadeInUp">
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="tag-list">
                            @foreach($tags as $tag)
                                <a class="item" title="Phone" href="category.html">{{$tag->pro_tag_en}}</a>
                            @endforeach
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"><a
                                                                href="{{url('product/details/'.$product->id.'/'.$product->pro_slug_en)}}"><img
                            ...
                            <div class="tab-pane" id="category{{$category->id}}">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme"
                                         data-item="4">
                                        @php
                                            $catWiseData = App\Models\Product::where('category_id',$category->id)->orderBy('id','DESC')->get();
                                        @endphp
