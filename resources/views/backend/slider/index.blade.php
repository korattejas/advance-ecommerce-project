                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href="{{route('add.slider')}}" style="float: right"
                               class="btn btn-rounded btn-success mb-5">Add Slider</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                            ...
                                            <td>
                                                ...
                                                @if($item->status == 1)
                                                    <a href="{{route('slider.inActive',$item->id)}}"
                                                       class="btn btn-danger mb-5" title="InActive Now"><i
                                                            class="fa fa-arrow-down"></i></a>
                                                @else
                                                    <a href="{{route('slider.active',$item->id)}}"
                                                       class="btn btn-success mb-5" title="Active Now"><i
